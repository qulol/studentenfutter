...
<head>
    ...
    <title>Impressum - Trail-Mix</title>
</head>
...
<div class="wrapper" id="wrapper">
    ...
    <div class="regular-top-content-wrapper">
        <div class="regular-top-content-block scrollbar white-bg" id="top-text">
            <h1 class="centered">Impressum</h1>
            <div class="text-paragraph">
                <h4>Angaben gem. § 5 TMG:</h4>
                <table class="formated-table">
                    <tr>
                        <td class="formated-table-data">Vorname, Name</td>
                        <td class="formated-table-data">Mustermann, Ralf</td>
                    </tr>
                    <tr>
                        <td class="formated-table-data">Adresse</td>
                        <td class="formated-table-data">BlubbBlubbStraße 15</td>
                    </tr>
                    <tr>
                        <td class="formated-table-data">PLZ</td>
                        <td class="formated-table-data">99999 Entenhausen</td>
                    </tr>
                </table>
            </div>
            ...
            <div class="text-paragraph">
                ...
                <table class="formated-table">
                    <tr>
                        <td class="formated-table-data">Telefon:</td>
                        <td class="formated-table-data">0152 / 9999 666</td>
                    </tr>
                    <tr>
                        <td class="formated-table-data">Fax:</td>
                        <td class="formated-table-data">nicht vorhanden</td>
                    </tr>
                    <tr>
                        <td>E-Mail:</td>
                        <td>spammails-not-allowed@blubbmail.de</td>
                    </tr>
                    <tr>
                        <td>Umsatzsteuer-ID</td>
                        <td>991456584985454</td>
                    </tr>
                </table>
            </div>
            <div class="text-paragraph">
                <h4>Umsatzsteuer-Identifikationsnummer gem. § 27 a Umsatzsteuergesetz:</h4>
                <p>DE XXX XXX XXX</p>
            </div>
            <div class="text-paragraph">
            ...
            <div class="text-paragraph">
                ...
                <p>
                    ...
                    Gewähr
                    auf Richtigkeit der Inhalte übernehmen. Für die Inhalte der externen Links sind die jeweilige
                    Anbieter
                    oder
                ...
                <p>
                    ...
                    waren im
                    Zeitpunkt der Linksetzung frei von rechtswidrigen Inhalten. Eine ständige inhaltliche Überprüfung
                    der
                    externen Links ist ohne konkrete Anhaltspunkte einer Rechtsverletzung nicht möglich. Bei direkten
                    oder
                    indirekten Verlinkungen auf die Webseiten Dritter, die außerhalb unseres Verantwortungsbereichs
                    liegen,
                    würde eine Haftungsverpflichtung ausschließlich in dem Fall nur bestehen, wenn wir von den Inhalten
                    Kenntnis
                    erlangen und es uns technisch möglich und zumutbar wäre, die Nutzung im Falle rechtswidriger Inhalte
                    zu
                    verhindern.
                </p>
                <p>
